...
public class jpegDecompressor extends jpeg {
    public jpegDecompressor(final String path) {
    ...
    @Override
    protected void huffman(){ //Ha de desfer el huffman amb la classe de huffman. Com que no ho tinc de moment fa això.
...
//            System.out.println(count);
    ...
    public String decompress() {
        ...
        return "Compressió creada correctament al fitxer out.jpegDelQuim"; //Això canviarà de cara a la segona entrega.
    }
